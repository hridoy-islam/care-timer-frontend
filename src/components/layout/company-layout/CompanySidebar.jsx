...
const AdminSidebar = forwardRef(({ showNav }, ref) => {
  ...
  return (
    <div
      ref={ref}
      className="fixed z-50 w-72 h-full bg-gray-50 shadow-2xl px-3 transition-all duration-200"
    >
      ...
      <ul className="hs-accordion-group">
        <li
          className={`flex justify-start items-center text-lg  mt-12 text-secondary  rounded-lg px-2 py-2 ${
            pathname == "/company"
        ...
        <li className="hs-accordion" id="account-accordion">
          ...
          >
            ...
            Team Member
            <svg
              className="hs-accordion-active:block  hidden w-3 h-3 text-secondary "
              width="16"
              height="16"
              viewBox="0 0 16 16"
              fill="none"
            ...
            <svg
              className="hs-accordion-active:hidden  block w-3 h-3 text-secondary "
              width="16"
              height="16"
              viewBox="0 0 16 16"
              fill="none"
            ...
            <ul className=" pl-2">
              <li>
                <Link
                  ...
                  className={`block text-lg pl-4 font-base py-2 ml-3 rounded-lg my-2 text-secondary ${
                ...
                >
                  <span className="flex items-center ">
                    <AiOutlinePlus />
                    <span className="pl-2">Add Team Member</span>
                  </span>
                </Link>
              </li>
              <li>
                <Link
                  href="/company/teamMember/allTeamMember"
                  className={`block text-lg pl-4 font-base py-2 ml-3 rounded-lg my-2 text-secondary ${
                ...
                >
                  <span className="flex items-center ">
                    <AiOutlineTable />
                    <span className="pl-2">All Team Member</span>
                  </span>
                </Link>
              </li>
              <li>
                <Link
                  href="/company/teamMember/archiveTeamMember"
                  className={`block text-lg pl-4 font-base py-2 ml-3 rounded-lg my-2 text-secondary ${
                ...
                >
                  <span className="flex items-center ">
                    <BiSolidArchiveIn />
                    <span className="pl-2">Archive Team Member</span>
                  </span>
                </Link>
              </li>
            </ul>
            ...
            <ul className="pl-2">
              <li>
                ...
                >
                  <span className="flex items-center ">
                    <AiOutlinePlus />
                    <span className="pl-2">Add Service User</span>
                  </span>
                </Link>
              </li>
              <li>
                <Link
                  href="/company/serviceUser/allServiceUser"
                  className={`block text-lg pl-4 font-base py-2 ml-3 rounded-lg my-2 text-secondary ${
                ...
                >
                  <span className="flex items-center ">
                    <AiOutlineTable />
                    <span className="pl-2">All Service User</span>
                  </span>
                </Link>
              </li>
              <li>
                <Link
                  href="/company/serviceUser/archiveServiceUser"
                  className={`block text-lg pl-4 font-base py-2 ml-3 rounded-lg my-2 text-secondary ${
                ...
                >
                  <span className="flex items-center ">
                    <BiSolidArchiveIn />
                    <span className="pl-2">Archive Service User</span>
                  </span>
                </Link>
              </li>
            </ul>
            ...
            <ul className=" pl-2">
              <li>
                ...
                >
                  <span className="flex items-center ">
                    <AiOutlinePlus />
                    <span className="pl-2">Add Tasklist</span>
                  </span>
                </Link>
              </li>
              <li>
                <Link
                  href="/company/tasklist/allTasklist"
                  className={`block text-lg pl-4 font-base py-2 ml-3 rounded-lg my-2 text-secondary ${
                ...
                >
                  <span className="flex items-center ">
                    <AiOutlineTable />
                    <span className="pl-2">All Tasklist</span>
                  </span>
                </Link>
              </li>
              <li>
                <Link
                  href="/company/tasklist/archiveTasklist"
                  className={`block text-lg pl-4 font-base py-2 ml-3 rounded-lg my-2 text-secondary ${
                ...
                >
                  <span className="flex items-center ">
                    <AiOutlineTable />
                    <span className="pl-2">Archive Tasklist</span>
                  </span>
                </Link>
              </li>
            </ul>
        ...
        <li
          className={`flex justify-start items-center text-lg text-secondary  rounded-lg px-2 py-2 my-2  ${
        ...
        >
          ...
          <Link href="/company/report">Report</Link>
        </li>
        <li
          className={`flex justify-start items-center text-lg text-secondary  rounded-lg px-2 py-2 my-2 ${
        ...
        >
          ...
          <Link href="/company/schedule/addSchedule">Schedule</Link>
        </li>
        ...
        >
          ...
          <Link href="/company/payDay">Pay Date</Link>
        </li>
      </ul>
    </div>
  );
