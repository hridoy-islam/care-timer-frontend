...
const Page = () => {
  ...
  const fetchData = () => {
    axios
      .get(
        `${process.env.NEXT_PUBLIC_API_URL}/worker/?page=${currentPage}&limit=${itemsPerPage}&softDelete=true&sort_by={"updatedAt":-1}`,
        {
          headers: {
  ...
  return (
    <div>
      <div className="lg:w-3/4 px-4 py-10 sm:px-3 lg:px-4 lg:py-4 mx-auto">
                          ...
                          <td className="h-px w-24 whitespace-nowrap">
                            <div className="flex justify-evenly ">
                              <div className="hs-tooltip inline-block">
                                <Link
                                  href={`/company/teamMember/archiveTeamMember/archiveViewTeamMember/${item._id}`}
                                >
                                  <button
                                    type="button"
