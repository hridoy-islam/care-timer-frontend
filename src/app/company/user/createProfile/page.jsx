...
const page = () => {
  return (
    <div>
      <div className="w-full px-4 py-10 sm:px-6 lg:px-8 lg:py-6 mx-auto">
        <div className="bg-white rounded-xl shadow p-4 sm:p-7 dark:bg-slate-900">
          ...
          <form>
            <div className="grid sm:grid-cols-12 gap-2 sm:gap-6">
              ...
              <div className="sm:col-span-9">
                <label className="block">
                  ...
                  <input
                    type="file"
                    className="block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-md file:border-0 file:text-sm file:font-semibold file:bg-primary file:text-white hover:file:bg-primary"
                  />
                </label>
              </div>
              ...
              <div className="sm:col-span-9">
                <div className="sm:flex">
                  <label
                    for="af-account-gender-checkbox"
                    className="flex py-2 px-3  w-full border border-gray-200 shadow-sm -mt-px -ml-px first:rounded-t-lg last:rounded-b-lg sm:first:rounded-l-lg sm:mt-0 sm:first:ml-0 sm:first:rounded-tr-none sm:last:rounded-bl-none sm:last:rounded-r-lg text-sm relative focus:z-10 focus:border-blue-500 focus:ring-blue-500 dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400"
                  >
                    <input
                      type="radio"
            ...
            <div className="mt-5 flex justify-end gap-x-2">
              ...
              <button
                type="button"
                className="py-2 px-3 inline-flex justify-center items-center gap-2 rounded-md border border-transparent font-semibold bg-primary text-white hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all text-sm dark:focus:ring-offset-gray-800"
              >
                Save changes
              </button>
            </div>
