                ...
                <div class="px-6 py-4 grid gap-3 border-b border-gray-200 ">
                  ...
                  <div>
                    <div class="flex justify-between items-center gap-x-2">
                      ...
                      <div>
                        <label className='pb-1 pl-1 text-sm font-base font-serif'>Filter By Team Member</label>
                        <Select className='w-48 py-1  focus:ring-primary border-gray-300' options={teamMember} />
                      </div>

                      <div>
                        <label className='pb-1 pl-1 text-sm font-base font-serif'>Filter By Service User</label>
                        <Select className='w-48 py-1  focus:ring-primary border-gray-300' options={serviceUser} />
                      </div>
                      <div>
