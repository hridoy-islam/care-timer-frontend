...
const Page = () => {
  ...
  const fetchData = () => {
    axios
      .get(
        `${process.env.NEXT_PUBLIC_API_URL}/customer/?page=${currentPage}&limit=${itemsPerPage}&softDelete=true&company=${tokenDetails?.data?._id}&sort_by={"updatedAt":-1}`,
        {
          headers: {
