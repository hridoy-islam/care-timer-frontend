...
const page = () => {
  ...
  const onsubmit = (data) => {
    axios
      .post(`${process.env.NEXT_PUBLIC_API_URL}/company`, data, {
        headers: {
                ...
                <div className="col-span-3">
                  ...
                  <div className="input-group mt-4 relative">
                    <input
                      ...
                      {...register("password")}
                      name="password"
                      className="form-control pl-4 w-full rounded-md border-0 py-3 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-md sm:leading-6"
                    />
                    <div className="input-group-btn absolute right-4 top-3">
                      <button
                        type="button"
                        className="btn btn-outline-primary text-xl"
