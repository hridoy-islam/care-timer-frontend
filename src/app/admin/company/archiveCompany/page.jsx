...
const Page = () => {
  ...
  const fetchData = () => {
    axios.get(`${process.env.NEXT_PUBLIC_API_URL}/company/?page=${currentPage}&limit=${itemsPerPage}&softDelete=true&role=company&sort_by={"updatedAt":-1}`, {
      headers: {
